...
<p className="text-lg text-indigo-200/65">
              We don't use old, recycled Xeon processors. Every Afterdab server runs on a dedicated Ryzen 9700X (5.5GHz Boost) out of Montreal, QC (BHS Datacenter).
            </p>
          </div>
          {/* Items */}
...
<article>
              ...
              <p className="text-indigo-200/65">
                Direct fiber routes from Montreal to the East Coast mean your DayZ shots register instantly and your blocks don't lag.
              </p>
            </article>
            <article>
              <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <p className="text-indigo-200/65">
                Our pre-configured Purpur eggs come with Geyser and Floodgate built-in. Xbox, PlayStation, and PC players can join instantly.
              </p>
            </article>
<article>
              <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                Full SFTP & MySQL Control
              </h3>
              <p className="text-indigo-200/65">
                We don't lock you down. Get full SFTP access to upload massive modpacks, plus dedicated MySQL databases for your plugins.
              </p>
            </article>
            <article>
              <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <p className="text-indigo-200/65">
                World generation and chunk loading shouldn't lag the server. We use enterprise NVMe drives so everything loads instantly.
              </p>
            </article>
            <article>
              <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <p className="text-indigo-200/65" id="free-tier">
                Need to host a Discord bot or API? We offer limited free slots specifically for Python and Node.js environments.
              </p>
            </article>
<article>
              <svg className="mb-3 fill-indigo-500" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              <p className="text-indigo-200/65">
                No outsourced tier-1 script readers. When you submit a ticket, it goes directly to the engineers who actually built the node.
              </p>
            </article>
          </div>
        </div>
