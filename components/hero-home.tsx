...
<h1 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-500),var(--color-gray-50),var(--color-indigo-200),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-5 font-nacelle text-4xl font-semibold text-transparent md:text-5xl" data-aos="fade-up">
...
<div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
  <div data-aos="fade-up" data-aos-delay={400}>
    <a className="btn group mb-4 w-full bg-indigo-600 text-white shadow-sm hover:bg-indigo-500 sm:mb-0 sm:w-auto" href="https://billing.afterdab.com/products/premium">
  ...
  <div data-aos="fade-up" data-aos-delay={600}>
    <a className="btn w-full bg-gray-800 text-gray-200 hover:bg-gray-700 sm:ml-4 sm:w-auto" href="#0">
      Join Discord
    </a>
  </div>
</div>
